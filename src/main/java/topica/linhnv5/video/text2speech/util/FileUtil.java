package topica.linhnv5.video.text2speech.util;
...
public class FileUtil {
	 ...
	 * Write file content
	 * @param f file
	 * @param ab the file contain
	 * @throws Exception
	 */
	public static void writeFileContent(File f, byte[] ab) throws Exception {
		Files.write(Paths.get(f.getPath()), ab);
	}
